...
{
    public class vCatalogController : Controller
    {
        ...
        {
            List<tstproduct> tApp = tstdb.tstproducts.Where(x => x.OwnerId != 0).ToList();
        ...
        //[HttpGet]
        public JsonResult AddEditProduct(int? id)
        {
            return Json(tstdb.tstapplications.Where(x => x.Id == id), JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult AddEditProduct(tstapplication app)
        {
            app.OwnerId = 100;
        ...
        {
            List<tstproducts_customers> tApp = tstdb.tstproducts_customers.Where(x => x.OwnerId != 0).ToList();
        ...
        //[HttpGet]
        public JsonResult AddEditCustomer(int? id)
        {
            return Json(tstdb.tstapplications.Where(x => x.Id == id), JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult AddEditCustomer(tstapplication app)
        {
            app.OwnerId = 100;
            if (ModelState.IsValid)
            {
        ...
        {
            List<tstproducts_manufacturers> tApp = tstdb.tstproducts_manufacturers.Where(x => x.OwnerId != 0).ToList();
        ...
        //[HttpGet]
        public JsonResult AddEditManufacturer(int? id)
        {
            return Json(tstdb.tstapplications.Where(x => x.Id == id), JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult AddEditManufacturer(tstapplication app)
        {
            app.OwnerId = 100;
            if (ModelState.IsValid)
            {
        ...
        {
            List<tstproducts_searches> tApp = tstdb.tstproducts_searches.Where(x => x.OwnerId != 0).ToList();
        ...
        {
            List<tstproducts_tags> tApp = tstdb.tstproducts_tags.Where(x => x.OwnerId != 0).ToList();
        ...
        //[HttpGet]
        public JsonResult AddEditTag(int? id)
        {
            return Json(tstdb.tstapplications.Where(x => x.Id == id), JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult AddEditTag(tstapplication app)
        {
            app.OwnerId = 100;
            if (ModelState.IsValid)
            {
