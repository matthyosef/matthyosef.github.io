...
{
    public class vCampaignsController : Controller
    {
        ...
        //[HttpGet]
        public JsonResult AddEditCampaign(int? id)
        {
            return Json(tstdb.tstapplications.Where(x => x.Id == id), JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult AddEditCampaign(tstapplication app)
        {
            app.OwnerId = 100;
        ...
        {
            List<tstcampaigns_brands> tApp = tstdb.tstcampaigns_brands.Where(x => x.OwnerId != 0).ToList();
        ...
        {
            List<tstcampaigns_collections> tApp = tstdb.tstcampaigns_collections.Where(x => x.OwnerId != 0).ToList();
        ...
        {
            List<tstcampaigns_polls> tApp = tstdb.tstcampaigns_polls.Where(x => x.OwnerId != 0).ToList();
        ...
        //[HttpGet]
        public JsonResult AddEditPoll(int? id)
        {
            return Json(tstdb.tstapplications.Where(x => x.Id == id), JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult AddEditPoll(tstapplication app)
        {
            app.OwnerId = 100;
            if (ModelState.IsValid)
            {
        ...
        #region PollAnswers
        public ActionResult PollAnswers()
        {
            List<tstcampaigns_pollanswer> tApp = tstdb.tstcampaigns_pollanswer.Where(x => x.OwnerId != 0).ToList();
        ...
        public JsonResult GetPollAnswers()
        {
            List<tstapplication> tApp = tstdb.tstapplications.Where(x => x.OwnerId != 0 && x.IsDeleted != true).ToList();
        ...
        //[HttpGet]
        public JsonResult AddEditPollAnswers(int? id)
        {
            return Json(tstdb.tstapplications.Where(x => x.Id == id), JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult AddEditPollAnswers(tstapplication app)
        {
            app.OwnerId = 100;
            if (ModelState.IsValid)
            {
        ...
        //[HttpPost]
        public JsonResult DeletePollAnswers(int? id)
        {
            //app.OwnerId = 100;
            var app = tstdb.tstapplications.SingleOrDefault(x => x.Id == id);
            if (app != null)
        ...
        {
            List<tstcampaigns_votes> tApp = tstdb.tstcampaigns_votes.Where(x => x.Id != 0).ToList();
        ...
        //[HttpGet]
        public JsonResult AddEditVote(int? id)
        {
            return Json(tstdb.tstapplications.Where(x => x.Id == id), JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult AddEditVote(tstapplication app)
        {
            app.OwnerId = 100;
            if (ModelState.IsValid)
            {
