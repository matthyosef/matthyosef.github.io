...
{
    public class vPromotionsController : Controller
    {
        ...
        {
            List<tstproducts_affiliates> tApp = tstdb.tstproducts_affiliates.Where(x => x.OwnerId != 0).ToList();
        ...
        //[HttpGet]
        public JsonResult AddEditAffiliate(int? id)
        {
            return Json(tstdb.tstapplications.Where(x => x.Id == id), JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult AddEditAffiliate(tstapplication app)
        {
            app.OwnerId = 100;
        ...
        {
            List<tstproducts_discounts> tApp = tstdb.tstproducts_discounts.Where(x => x.OwnerId != 0).ToList();
        ...
        //[HttpGet]
        public JsonResult AddEditDiscount(int? id)
        {
            return Json(tstdb.tstapplications.Where(x => x.Id == id), JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult AddEditDiscount(tstapplication app)
        {
            app.OwnerId = 100;
            if (ModelState.IsValid)
            {
        ...
        {
            List<tstproducts_banners> tApp = tstdb.tstproducts_banners.Where(x => x.OwnerId != 0).ToList();
        ...
        //[HttpGet]
        public JsonResult AddEditBanner(int? id)
        {
            return Json(tstdb.tstapplications.Where(x => x.Id == id), JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult AddEditBanner(tstapplication app)
        {
            app.OwnerId = 100;
            if (ModelState.IsValid)
            {
