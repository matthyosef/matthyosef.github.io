...
{
    public class vNewslettersController : Controller
    {
        ...
        public JsonResult GetNewsletters()
        {
        ...
        //[HttpGet]
        public JsonResult AddEditNewsletter(int? id)
        {
            return Json(tstdb.tstapplications.Where(x => x.Id == id), JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult AddEditNewsletter(tstapplication app)
        {
            app.OwnerId = 100;
        ...
        {
            List<tstnewsletters_brands> tApp = tstdb.tstnewsletters_brands.Where(x => x.OwnerId != 0).ToList();
        ...
        {
            List<tstnewsletters_collections> tApp = tstdb.tstnewsletters_collections.Where(x => x.OwnerId != 0).ToList();
        ...
        {
            List<tstnewsletters_searches> tApp = tstdb.tstnewsletters_searches.Where(x => x.OwnerId != 0).ToList();
        ...
        {
            List<tstnewsletters_subscription> tApp = tstdb.tstnewsletters_subscription.Where(x => x.OwnerId != 0).ToList();
