...
{
    public class vClassifiedsController : Controller
    {
        ...
        public JsonResult GetClassifieds()
        {
        ...
        //[HttpGet]
        public JsonResult AddEditClassified(int? id)
        {
            return Json(tstdb.tstapplications.Where(x => x.Id == id), JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult AddEditClassified(tstapplication app)
        {
            app.OwnerId = 100;
        ...
        //[HttpPost]
        public JsonResult DeleteClassified(int? id)
        {
            //app.OwnerId = 100;
        ...
        {
            List<tstclassifieds_collections> tApp = tstdb.tstclassifieds_collections.Where(x => x.OwnerId != 0).ToList();
        ...
        {
            List<tstclassifieds_searches> tApp = tstdb.tstclassifieds_searches.Where(x => x.OwnerId != 0).ToList();
