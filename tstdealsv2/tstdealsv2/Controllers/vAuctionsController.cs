...
{
    public class vAuctionsController : Controller
    {
        ...
        //[HttpGet]
        public JsonResult AddEditAuction(int? id)
        {
            return Json(tstdb.tstapplications.Where(x => x.Id == id), JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult AddEditAuction(tstapplication app)
        {
            app.OwnerId = 100;
        ...
        //[HttpPost]
        public JsonResult DeleteAuction(int? id)
        {
            //app.OwnerId = 100;
        ...
        {
            List<tstauctions_brands> tApp = tstdb.tstauctions_brands.Where(x => x.OwnerId != 0).ToList();
        ...
        {
            List<tstauctions_collections> tApp = tstdb.tstauctions_collections.Where(x => x.OwnerId != 0).ToList();
        ...
        {
            List<tstauctions_offers> tApp = tstdb.tstauctions_offers.Where(x => x.Id != 0).ToList();
        ...
        //[HttpGet]
        public JsonResult AddEditOffer(int? id)
        {
            return Json(tstdb.tstapplications.Where(x => x.Id == id), JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult AddEditOffer(tstapplication app)
        {
            app.OwnerId = 100;
            if (ModelState.IsValid)
            {
        ...
        {
            List<tstauctions_searches> tApp = tstdb.tstauctions_searches.Where(x => x.OwnerId != 0).ToList();
